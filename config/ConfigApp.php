...
class ConfigApp {
    ...
    public static $ACTIONS = [
      ...
      'editarDatos'=> 'RegisterController#EditarDatos',
      ...
      'agregarHecho'=> 'personajesController#InsertHecho',
      'borrarHecho'=> 'personajesController#BorrarHecho',
      'borrarPersonaje'=> 'personajesController#BorrarPersonaje',
      'editarHecho'=> 'personajesController#EditarHecho',
      'modificarHecho'=>'personajesController#ModificarHecho',
      'editarPersonaje'=>'personajesController#EditarPersonaje',
      'modificarPerso'=>'personajesController#ModificarPerso',
      'personajes'=>'personajesController#Home',
